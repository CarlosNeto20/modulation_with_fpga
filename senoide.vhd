...
architecture rtl of senoide is
    ...
    constant SINE_LUT : rom_type := (
		 512, 537, 562, 587, 612, 636, 660, 684, 708, 730, 753, 775, 796, 816, 836, 855,
		 873, 891, 907, 922, 937, 950, 963, 974, 984, 993, 1001, 1008, 1013, 1017, 1021, 1022,
		 1023, 1022, 1021, 1017, 1013, 1008, 1001, 993, 984, 974, 963, 950, 937, 922, 907, 891,
		 873, 855, 836, 816, 796, 775, 753, 730, 708, 684, 660, 636, 612, 587, 562, 537,
		 512, 487, 462, 437, 412, 388, 364, 340, 316, 294, 271, 249, 228, 208, 188, 169,
		 151, 133, 117, 102, 87, 74, 61, 50, 40, 31, 23, 16, 11, 7, 3, 2,
		 1, 2, 3, 7, 11, 16, 23, 31, 40, 50, 61, 74, 87, 102, 117, 133,
		 151, 169, 188, 208, 228, 249, 271, 294, 316, 340, 364, 388, 412, 437, 462, 487
    );
    ...
    constant PASSO : unsigned(31 downto 0) := to_unsigned(25770, 32);
	 ...
	 -- Passo para 2000 Hz (Frequência maior para visualização rápida no simulador)
	 -- constant PASSO : unsigned(31 downto 0) := to_unsigned(858993, 32);

	 -- Índice inteiro de 0 a 127 para varrer a LUT
